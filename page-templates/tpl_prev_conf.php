<?php
    /* Template Name: Previous Conference Page */
    ...
    <div class="grid post">
        <div class="unit whole">
            ...
            <p>High quality photos of the first day (12 December): <a href="https://yadi.sk/d/MYPA58lM_4o1GA"
                                                                      target="_blank"><strong>download</strong></a>
                (516.6 MB)</p>
            ...
            <p>Printed Russian version: <a href="<?php echo get_template_directory_uri();?>/media/MICSECS_RUS_2018.pdf" target="_blank"><strong>download</strong></a>
            </p>
